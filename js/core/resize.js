...
function Resize(
  ...
  this.resizeCallback =
    typeof resizeCallback == 'function' ? resizeCallback : function (returnedArray) {};
...
Resize.prototype.initialize = function () {
  ...
  if (
    ...
    if (this.useWebWorker) {
      this.useWebWorker =
        this.widthOriginal != this.targetWidth || this.heightOriginal != this.targetHeight;
      if (this.useWebWorker) {
  ...
  for (
    ...
    for (
      ...
      outputBuffer[finalOffset] =
        buffer[pixelOffset] * firstWeight + buffer[pixelOffset + 3] * secondWeight;
...
Resize.prototype.resizeWidthInterpolatedRGBA = function (buffer) {
  ...
  for (
    ...
    for (
      ...
      outputBuffer[finalOffset] =
        buffer[pixelOffset] * firstWeight + buffer[pixelOffset + 4] * secondWeight;
      outputBuffer[finalOffset + 1] =
